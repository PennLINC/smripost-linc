...
from smripost_linc.cli import run
from smripost_linc.cli.parser import parse_args
from smripost_linc.cli.workflow import build_boilerplate, build_workflow
from smripost_linc.reports.core import generate_reports
from smripost_linc.tests.utils import (
    check_generated_files,
    download_test_data,
    get_test_data_path,
)
from smripost_linc.utils.bids import write_derivative_description


@pytest.mark.integration
@pytest.mark.ds005115_deriv_only
def test_ds005115_deriv_only(data_dir, output_dir, working_dir):
    """Run sMRIPost-LINC on ds005115 fMRIPrep derivatives with MNI152NLin6Asym-space data."""
...
def test_ds005115_deriv_and_raw(data_dir, output_dir, working_dir):
    """Run sMRIPost-LINC on ds005115 raw BIDS + fMRIPrep derivatives w/o MNI152NLin6Asym data."""
...
def test_ds005115_resampling_and_raw(data_dir, output_dir, working_dir):
    """Run sMRIPost-LINC on ds005115 raw BIDS + resampling-level fMRIPrep derivatives."""
