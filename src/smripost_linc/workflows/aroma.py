...
#
"""sMRIPost-LINC workflows to run ICA-AROMA."""

from nipype.interfaces import utility as niu
from nipype.pipeline import engine as pe

from smripost_linc import config
from smripost_linc.interfaces.aroma import AROMAClassifier
from smripost_linc.interfaces.bids import DerivativesDataSink
from smripost_linc.utils.utils import _get_wf_name
...
def init_ica_aroma_wf(
    *,
    ...
    <http://nbviewer.jupyter.org/github/pennlinc/fmriprep-notebooks/blob/
    ...
    Workflow Graph
        .. workflow::
            ...
            from smripost_linc.workflows.bold.confounds import init_ica_aroma_wf
    ...
    from smripost_linc.interfaces.confounds import ICAConfounds
    from smripost_linc.interfaces.nilearn import MeanImage, MedianValue
    from smripost_linc.interfaces.reportlets import ICAAROMARPT, ICAAROMAMetricsRPT
    from smripost_linc.utils.utils import _convert_to_tsv
...
def init_denoise_wf(bold_file, metadata):
    ...
    from smripost_linc.interfaces.confounds import ICADenoise
    from smripost_linc.workflows.confounds import init_carpetplot_wf
