...
#
# Copyright The NiPreps Developers <pennlinc@gmail.com>
#
...
from smripost_linc.config import DEFAULT_MEMORY_MIN_GB
...
def init_func_fit_reports_wf(
    *,
    ...
    from smripost_linc.interfaces.nilearn import MeanImage
