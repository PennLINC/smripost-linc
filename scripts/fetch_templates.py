...
1. wget https://raw.githubusercontent.com/pennlinc/fmriprep-aroma/main/scripts/fetch_templates.py
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Helper script for pre-caching required templates to run sMRIPost-LINC',
    )
    parser.add_argument(
        '--tf-dir',
