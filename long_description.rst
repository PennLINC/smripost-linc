sMRIPost-LINC is a postprocessing BIDS App that ingests preprocessed anatomical MRI data and parcellates it.
...
[Documentation `smripost_linc.org <https://smripost_linc.readthedocs.io>`_]
[Support `neurostars.org <https://neurostars.org/tags/smripost_linc>`_]

License information
-------------------
*sMRIPost-LINC* adheres to the
...
As of the 21.0.x pre-release and release series, *sMRIPost-LINC* is
