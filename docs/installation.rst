...
Installation
------------
*sMRIPost-LINC* should be installed using container technologies.
...
================================================
*sMRIPost-LINC* is a *NiPreps* application, and therefore follows some overarching principles
...
`Docker <https://www.pennlinc.org/apps/docker/>`__
or `Singularity <https://www.pennlinc.org/apps/singularity/>`__ subsections.

External Dependencies
---------------------
*sMRIPost-LINC* is written using Python 3.8 (or above), and is based on
nipype_.

*sMRIPost-LINC* requires some other neuroimaging software tools that are
...
===============================================
If you intend to run *sMRIPost-LINC* on a remote system, you will need to
