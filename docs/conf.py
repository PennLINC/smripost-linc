# smripost_linc documentation build configuration file, created by
...
project = 'sMRIPost-LINC'
author = 'The sMRIPost-LINC developers'
...
# html_title = u'smripost_linc vversion'
...
htmlhelp_basename = 'smripost_linc_doc'
...
latex_documents = [
    (master_doc, 'smripost_linc.tex', 'sMRIPost-LINC Documentation', author, 'manual'),
]
...
man_pages = [(master_doc, 'smripost-linc', 'sMRIPost-LINC Documentation', [author], 1)]
...
linkcode_resolve = make_linkcode_resolve(
    'smripost_linc',
    'https://github.com/pennlinc/sMRIPost-LINC/blob/{revision}/{package}/{path}#L{lineno}',
)
...
intersphinx_mapping = {
    ...
    'niworkflows': ('https://www.pennlinc.org/niworkflows/', None),
    'fmriprep': ('https://fmriprep.org/en/stable/', None),
    'sdcflows': ('https://www.pennlinc.org/sdcflows/', None),
    'smriprep': ('https://www.pennlinc.org/smriprep/', None),
